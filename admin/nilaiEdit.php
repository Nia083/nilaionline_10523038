...
<tr>
    <td>NILAI TUGAS</td>
    <td>:</td>
    <td><input name="nl_tugas" type="text" id="nl_tugas" size="30" placeholder="TUGAS"/></td>
</tr>
<tr>
    <td>NILAI UTS</td>
    <td>:</td>
    <td><input name="nl_uts" type="text" id="nl_uts" size="30" placeholder="UTS"/></td>
</tr>
<tr>
    <td>NILAI UAS</td>
    <td>:</td>
    <td><input name="nl_uas" type="text" id="nl_uas" size="30" placeholder="UAS"/></td>
</tr>
<tr>
    <td>&nbsp;</td>
    <td>&nbsp;</td>
